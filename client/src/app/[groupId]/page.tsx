...
import sampleGalleryItems, { sampleUsers } from './gallery';
...
useEffect(() => {
    const loadGroupMedia = async () => {
        const response = await loadGroupMediaApi(groupId);
        if(response.success){
    ...
    const handleAddMedia = () => {
      ...
      const handleUploadSuccess = (media: unknown) => {
        // refresh gallery list or push to state
                                        ...
                                        <div className={styles.emptyState}>
                                            {isGalleryEmpty ? (
                                                <div className={styles.emptyState}>
                                                    ...
                                                    <p className={styles.emptyText}>No media yet</p>
                                                </div>
                                            ) : (

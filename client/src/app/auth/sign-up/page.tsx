...
function SignUpForm() {
  ...
  const { createUser, loading, error, success, isAuthenticated ,setError, setSuccess, setLoading} = useUserAuthStore();
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <p className="mt-6 text-center text-sm text-gray-600">
            ...
            <a onClick={handleSignIn} className="text-indigo-600 hover:text-indigo-700 font-semibold">
              Sign In
            </a>
          </p>
        </div>
